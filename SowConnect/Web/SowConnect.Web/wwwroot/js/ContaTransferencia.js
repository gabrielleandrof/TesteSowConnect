$(document).ready(function () {
    ...
    var grid = $('#grid').grid({
        dataSource: rootUri + 'ContaBancaria/ObterContas/',
        columns: [
            { field: 'idBanco', title: "Banco" },
            { field: 'idCliente', title: "Cliente" },
            { field: 'agencia', title: "Agencia" },
            { field: 'contaCorrente', title: "Conta Corrente" },
            { field: 'saldo', title: 'Saldo (R$)' }
        ]
    });

    //$.getJSON(rootUri + "ContaBancaria/", function (result) {
